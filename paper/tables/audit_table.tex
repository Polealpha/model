...
Tri-modal emotion benchmark & Complete (synthetic only) & Dual-A800 training confirms strong synthetic fusion performance, but this benchmark is still controlled and not a real-world perception claim. \\
Tri-modal care relation model & Complete (synthetic only) & Dual-A800 training confirms that multimodal affect cues can map to synthetic care need and care timing, but this is still not evidence of real-user intervention validity. \\
