...
\begin{itemize}[leftmargin=1.3em]
  \item We add a synthetic tri-modal benchmark for fine-grained emotion understanding from face, motion, and audio, and show that fusion is dramatically stronger than any single modality on this controlled benchmark.
