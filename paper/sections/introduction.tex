...
\begin{itemize}[leftmargin=1.3em]
  \item We add a synthetic tri-modal benchmark for fine-grained emotion understanding from face, motion, and audio, and a paired synthetic care benchmark that maps those multimodal cues to care need and care timing.
